...
| **Linux (Universal)** | `.AppImage` | {platform_line(linux, "Linux", "Community Build - unsigned installer with CI provenance")} |
| **Arch Linux** | `.pacman` | {platform_line(linux, "Linux", "Community Build - unsigned package with CI provenance")} |
| **Ubuntu/Debian** | `.deb` | {platform_line(linux, "Linux", "Community Build - unsigned package with CI provenance")} |
| **Fedora/RHEL** | `.rpm` | {platform_line(linux, "Linux", "Community Build - unsigned package with CI provenance")} |
